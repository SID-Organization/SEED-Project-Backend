...
public class AuthConfig {
    ...
    private CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("https://localhost:8081", "https://127.0.0.1:8081"));
    ...
    protected SecurityFilterChain configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.authorizeRequests().antMatchers("/login", "/login/auth").permitAll().anyRequest().permitAll();
